...
public class TextProcessor {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the filepath: "); //Prompts the user to enter the filepath to the designated file
        filename = s.nextLine();
        System.out.print("Enter a regex: "); //Prompts the user to enter regex
        regex = s.nextLine();
        s.close();
